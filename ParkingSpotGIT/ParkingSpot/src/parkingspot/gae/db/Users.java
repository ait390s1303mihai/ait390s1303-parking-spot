 ...
 * - "loginID" a {@link String} with the login ID of the admin (one of these, in this order: user id, email, external Open
...
public class Users {
     ...
     */
    private static final String PERMIT_PROPERTY = "permit";
     ...
     */
    public static boolean updateUserCommand(String userID, String name, String loginID) {
            Entity user = null;
            try {
            		user = getUser(userID);
